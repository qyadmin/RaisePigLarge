...
public class HttpImage : MonoBehaviour {
	...
	void Start()
	{
		...
		ShowError=GameObject.Find ("ShowError");
//		string A = Static.Instance.URL;
//		string B = Static.Instance.URLold;
//		if (A != null) {
//			A = UpdataURL.Replace (B, A);
//			UpdataURL = A;
//			LoadURL = Static.Instance.URL;
//		}
		Debug.Log (UpdataURL);
	}
	...
	public void SendIamge(byte[] GetTex)
	{
		StartCoroutine (UploadTexture(GetTex));
	}
